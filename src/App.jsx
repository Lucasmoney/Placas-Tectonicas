    ...
    <div className="grid-bg">
      <main>
        ...
        <footer style={{ padding: '3rem 5%', textAlign: 'center', backgroundColor: 'transparent', marginTop: '2rem' }}>
          <div style={{ padding: '2rem', borderRadius: '16px', background: 'rgba(255, 255, 255, 0.03)', border: '1px solid var(--color-grid)', boxShadow: '0 10px 30px rgba(0,0,0,0.2)', backdropFilter: 'blur(10px)' }}>
            ...
            <p style={{ color: '#e2e8f0', fontSize: '1.125rem', fontWeight: 600 }}>
