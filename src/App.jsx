    ...
    <div className="grid-bg">
      <main>
        ...
        <footer style={{ padding: '3rem 5%', textAlign: 'center', backgroundColor: 'transparent', marginTop: '2rem' }}>
          <div style={{ padding: '2rem', borderRadius: '16px', background: 'var(--color-card)', border: '1px solid var(--color-border)', boxShadow: '0 10px 30px rgba(0,0,0,0.2)' }}>
            <p style={{ color: 'var(--color-accent-alt)', fontSize: '0.875rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.5rem' }}>Equipe de Desenvolvimento</p>
