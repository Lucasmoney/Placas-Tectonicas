    ...
    <section className="section-container" style={{ backgroundColor: 'transparent' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
        <motion.div 
          ...
          style={{ padding: '2.5rem', border: '1px solid var(--color-border)', borderRadius: '16px', background: 'var(--color-card)', display: 'flex', flexDirection: 'column', transition: 'border-color 0.3s' }}
        >
          <Clock size={40} color="var(--color-accent-alt)" style={{ marginBottom: '1.5rem' }} />
        ...
        <motion.div 
          whileHover={{ y: -10, boxShadow: '0 20px 40px rgba(16, 185, 129, 0.15)', borderColor: '#10b981' }}
          style={{ padding: '2.5rem', border: '1px solid var(--color-border)', borderRadius: '16px', background: 'var(--color-card)', display: 'flex', flexDirection: 'column', transition: 'border-color 0.3s' }}
        >
        ...
        <motion.div 
          whileHover={{ y: -10, boxShadow: '0 20px 40px rgba(56, 189, 248, 0.15)', borderColor: 'var(--color-accent-alt)' }}
          style={{ padding: '2.5rem', border: '1px solid var(--color-border)', borderRadius: '16px', background: 'var(--color-card)', display: 'flex', flexDirection: 'column', transition: 'border-color 0.3s' }}
        >
          <Map size={40} color="var(--color-accent-alt)" style={{ marginBottom: '1.5rem' }} />
