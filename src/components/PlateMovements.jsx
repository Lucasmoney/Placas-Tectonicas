  ...
  return (
    <section className="section-container">
        ...
        {Object.keys(movements).map(type => (
          <button
            ...
            style={{
              ...
              color: activeTab === type ? 'var(--color-card)' : 'var(--color-text)',
              fontWeight: 600,
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'clamp(2rem, 8vw, 4rem)', alignItems: 'center' }}>
        ...
        <div style={{ flex: '1 1 300px', background: 'var(--color-card)', padding: '2.5rem', borderRadius: '24px', border: '1px solid var(--color-border)', boxShadow: '0 20px 40px rgba(0,0,0,0.2)', display: 'flex', flexDirection: 'column' }}>
