  ...
  return (
    <section className="section-container">
      <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
        ...
        <p className="text-body" style={{ maxWidth: '600px', margin: '1.5rem auto 0', color: 'var(--color-text-secondary)' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'clamp(2rem, 8vw, 4rem)', alignItems: 'center' }}>
        ...
        <div style={{ flex: '1 1 300px' }}>
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p style={{ fontSize: '1.25rem', color: 'var(--color-text-secondary)', marginBottom: '2.5rem' }}>{movements[activeTab].subtitle}</p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div>
                  ...
                  <div style={{ color: 'var(--color-text-secondary)', lineHeight: 1.6 }}>{movements[activeTab].action}</div>
                </div>
                ...
                <div>
                  ...
                  <div style={{ color: 'var(--color-text-secondary)', lineHeight: 1.6 }}>{movements[activeTab].signature}</div>
                </div>
                <div style={{ width: '100%', height: '1px', background: 'var(--color-grid)' }} />
                <div>
        ...
        <div style={{ flex: '1 1 300px', background: 'var(--color-card)', padding: '2.5rem', borderRadius: '24px', border: '1px solid var(--color-card-border)', boxShadow: '0 20px 40px rgba(0,0,0,0.2)', display: 'flex', flexDirection: 'column' }}>
